...
function blankPlan(): PlanDraft {
  return {
    ...
    limits: { products: 100, customers: 100, salesPerMonth: 300, users: 1 },
    isActive: true,
    isRecommended: false,
  };
}
