  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Desktop: centralizado com max-width, scroll apenas quando necessário
        "sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:max-h-[95vh] sm:rounded-lg sm:overflow-y-auto",
        // Animações
